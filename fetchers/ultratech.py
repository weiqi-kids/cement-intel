...
class UltratechFetcher(CompanyFetcher):
    """UltraTech 爬蟲"""

    company_id = "ultratech"
    company_name = "UltraTech"
    news_url = "https://www.ultratech.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.ultratech.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from UltraTech")
        return documents
