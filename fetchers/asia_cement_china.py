...
class AsiaCementChinaFetcher(CompanyFetcher):
    """Asia Cement China 爬蟲"""

    company_id = "asia_cement_china"
    company_name = "Asia Cement China"
    news_url = "https://www.asiacementchina.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.asiacementchina.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Asia Cement China")
        return documents
...
if __name__ == "__main__":
    fetcher = AsiaCementChinaFetcher()
