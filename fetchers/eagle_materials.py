...
class EagleMaterialsFetcher(CompanyFetcher):
    """Eagle Materials 爬蟲"""

    company_id = "eagle_materials"
    company_name = "Eagle Materials"
    news_url = "https://www.eaglematerials.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.eaglematerials.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Eagle Materials")
        return documents
