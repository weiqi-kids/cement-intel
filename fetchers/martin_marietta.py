...
class MartinMariettaFetcher(CompanyFetcher):
    """Martin Marietta 爬蟲"""

    company_id = "martin_marietta"
    company_name = "Martin Marietta"
    news_url = "https://www.martinmarietta.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.martinmarietta.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Martin Marietta")
        return documents
