...
class VulcanFetcher(CompanyFetcher):
    """Vulcan Materials 爬蟲"""

    company_id = "vulcan"
    company_name = "Vulcan Materials"
    news_url = "https://www.vulcanmaterials.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.vulcanmaterials.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Vulcan Materials")
        return documents
