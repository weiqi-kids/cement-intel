...
class TaiwanCementFetcher(CompanyFetcher):
    """Taiwan Cement 爬蟲"""

    company_id = "taiwan_cement"
    company_name = "Taiwan Cement"
    news_url = "https://www.taiwancement.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.taiwancement.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Taiwan Cement")
        return documents
