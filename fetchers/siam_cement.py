...
class SiamCementFetcher(CompanyFetcher):
    """Siam Cement 爬蟲"""

    company_id = "siam_cement"
    company_name = "Siam Cement"
    news_url = "https://www.siamcement.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.siamcement.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Siam Cement")
        return documents
