...
class AnhuiConchFetcher(CompanyFetcher):
    """Anhui Conch 爬蟲"""

    company_id = "anhui_conch"
    company_name = "Anhui Conch"
    news_url = "https://www.anhuiconch.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.anhuiconch.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Anhui Conch")
        return documents
