...
class ThyssenkruppFetcher(CompanyFetcher):
    """thyssenkrupp 爬蟲"""

    company_id = "thyssenkrupp"
    company_name = "thyssenkrupp"
    news_url = "https://www.thyssenkrupp.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.thyssenkrupp.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from thyssenkrupp")
        return documents
