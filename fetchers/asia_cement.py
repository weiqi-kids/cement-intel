...
class AsiaCementFetcher(CompanyFetcher):
    """Asia Cement 爬蟲"""

    company_id = "asia_cement"
    company_name = "Asia Cement"
    news_url = "https://www.asiacement.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.asiacement.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Asia Cement")
        return documents
