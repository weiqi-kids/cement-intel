...
class HolcimFetcher(CompanyFetcher):
    """Holcim 爬蟲"""

    company_id = "holcim"
    company_name = "Holcim"
    news_url = "https://www.holcim.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Holcim")
        return documents
