...
class TaiheiyoFetcher(CompanyFetcher):
    """Taiheiyo Cement 爬蟲"""

    company_id = "taiheiyo"
    company_name = "Taiheiyo Cement"
    news_url = "https://www.taiheiyocement.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.taiheiyocement.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Taiheiyo Cement")
        return documents
