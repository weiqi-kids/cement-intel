...
class HeidelbergFetcher(CompanyFetcher):
    """Heidelberg Materials 爬蟲"""

    company_id = "heidelberg"
    company_name = "Heidelberg Materials"
    news_url = "https://www.heidelbergmaterials.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.heidelbergmaterials.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Heidelberg Materials")
        return documents
